...
import { Currency, CurrencyAmount, Percent, Price, TradeType } from '@lyfebloc/lb-sdk-core';
/**
...
export declare class Trade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
     ...
     */
    static bestTradeExactIn<TInput extends Currency, TOutput extends Currency>(pairs: Pool[][], originalAmountIn: CurrencyAmount<TInput>, currencyOut: Currency, { maxNumResults, maxHops }?: BestTradeOptions, currentPairs?: Pool[], currencyAmountIn?: CurrencyAmount<Currency>, bestTrades?: Trade<TInput, TOutput, TradeType.EXACT_INPUT>[]): Trade<TInput, TOutput, TradeType.EXACT_INPUT>[];
    /**
     ...
     * @param bestTrades used in recursion; the current list of best trades
     */
    static bestTradeExactOut<TInput extends Currency, TOutput extends Currency>(pairs: Pool[][], currencyIn: TInput, originalAmountOut: CurrencyAmount<TOutput>, { maxNumResults, maxHops }?: BestTradeOptions, currentPairs?: Pool[], currencyAmountOut?: CurrencyAmount<Currency>, bestTrades?: Trade<TInput, TOutput, TradeType.EXACT_OUTPUT>[]): Trade<TInput, TOutput, TradeType.EXACT_OUTPUT>[];
}
