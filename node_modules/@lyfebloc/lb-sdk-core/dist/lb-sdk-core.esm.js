...
function validateRustTypeValue(value, rustType) {
  !JSBI.greaterThanOrEqual(value, ZERO) ? process.env.NODE_ENV !== "production" ? invariant(false, value + " is not a " + rustType + ".") : invariant(false) : void 0;
  !JSBI.lessThanOrEqual(value, RUST_TYPE_MAXIMA[rustType]) ? process.env.NODE_ENV !== "production" ? invariant(false, value + " is not a " + rustType + ".") : invariant(false) : void 0;
}
function validateValue(chainId, value) {
  ...
  if (chainType === ChainType.EVM) !JSBI.lessThanOrEqual(value, MaxUint256) ? process.env.NODE_ENV !== "production" ? invariant(false, 'AMOUNT') : invariant(false) : void 0;
}
...
function BaseCurrency(chainId, decimals, symbol, name) {
  ...
  this.chainId = chainId in ChainId ? chainId : ChainId.MAINNET;
...
var Token = /*#__PURE__*/function (_BaseCurrency) {
  ...
  function Token(chainId, address, decimals, symbol, name) {
    ...
    if (_this.chainType === ChainType.SOLANA) _this.mint = new PublicKey(_this.address);else _this.mint = null;
    return _this;
  }
  /**
...
export { BNtoJSBI, ChainId, ChainType, CurrencyAmount, Ether, Fraction, JSBItoBN, MaxUint256, NativeCurrency, Percent, Price, Rounding, Token, TokenAmount, TradeType, WETH, computePriceImpact, getChainType, sortedInsert, sqrt, validateAndParseAddress };
//# sourceMappingURL=lb-sdk-core.esm.js.map
