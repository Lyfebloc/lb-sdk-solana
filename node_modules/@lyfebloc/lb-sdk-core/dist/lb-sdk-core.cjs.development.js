...
var BNtoJSBI = function BNtoJSBI(value) {
  return JSBI.BigInt(value);
};
var JSBItoBN = function JSBItoBN(value) {
...
(function (ChainId) {
  ...
  ChainId[ChainId["SOLANA"] = 101] = "SOLANA";
  ChainId[ChainId["ETHW"] = 10001] = "ETHW";
})(exports.ChainId || (exports.ChainId = {}));
function getChainType(chainId) {
  if (chainId === exports.ChainId.SOLANA) return exports.ChainType.SOLANA;
  return exports.ChainType.EVM;
}
(function (ChainType) {
  ChainType["EVM"] = "EVM";
...
var RUST_TYPE_MAXIMA = (_RUST_TYPE_MAXIMA = {}, _RUST_TYPE_MAXIMA[RustType.u64] = /*#__PURE__*/JSBI.subtract( /*#__PURE__*/JSBI.exponentiate( /*#__PURE__*/JSBI.BigInt(2), /*#__PURE__*/JSBI.BigInt(64)), ONE), _RUST_TYPE_MAXIMA[RustType.U256] = /*#__PURE__*/JSBI.subtract( /*#__PURE__*/JSBI.exponentiate( /*#__PURE__*/JSBI.BigInt(2), /*#__PURE__*/JSBI.BigInt(256)), ONE), _RUST_TYPE_MAXIMA);
function validateRustTypeValue(value, rustType) {
  !JSBI.greaterThanOrEqual(value, ZERO) ?  invariant(false, value + " is not a " + rustType + ".")  : void 0;
  !JSBI.lessThanOrEqual(value, RUST_TYPE_MAXIMA[rustType]) ?  invariant(false, value + " is not a " + rustType + ".")  : void 0;
}
function validateValue(chainId, value) {
  var chainType = getChainType(chainId);
  if (chainType === exports.ChainType.SOLANA) validateRustTypeValue(value, RustType.u64);
  if (chainType === exports.ChainType.EVM) !JSBI.lessThanOrEqual(value, MaxUint256) ?  invariant(false, 'AMOUNT')  : void 0;
}
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  function CurrencyAmount(currency, numerator, denominator) {
    ...
    validateValue(currency.chainId, _this.quotient);
...
function BaseCurrency(chainId, decimals, symbol, name) {
  ...
  this.chainId = chainId in exports.ChainId ? chainId : exports.ChainId.MAINNET;
...
var isValidSolanaAddress = function isValidSolanaAddress(address) {
  try {
    if (!address) return false;
    var pub = new web3_js.PublicKey(address);
    if (web3_js.PublicKey.isOnCurve(pub)) return true;
...
function validateAndParseAddress(address$1, chainId) {
  try {
    var chainType = getChainType(chainId);
    if (chainType === exports.ChainType.SOLANA) {
      if (isValidSolanaAddress(address$1)) return address$1;
...
var Token = /*#__PURE__*/function (_BaseCurrency) {
  ...
  function Token(chainId, address, decimals, symbol, name) {
    ...
    if (_this.chainType === exports.ChainType.SOLANA) _this.mint = new web3_js.PublicKey(_this.address);else _this.mint = null;
    return _this;
  }
  /**
  ...
  _proto.sortsBefore = function sortsBefore(other) {
    ...
    if (this.chainType === exports.ChainType.SOLANA) return new BN(this.mint.toBytes()).lt(new BN(other.mint.toBytes()));
...
//# sourceMappingURL=lb-sdk-core.cjs.development.js.map
